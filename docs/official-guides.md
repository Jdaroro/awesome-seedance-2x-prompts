...
以下链接指向火山引擎或 BytePlus 官方文档。页面内容、下载权限和更新节奏由原网站维护。

> 最近核验：2026-09-06。BytePlus 官方 `Dreamina Seedance 2.5 prompt guide` 页面标注的更新时间为 2026-08-31 10:33:51。
...
- [BytePlus official online guide: Dreamina Seedance 2.5 prompt guide](https://docs.byteplus.com/en/docs/ModelArk/2607689)
- [Dreamina Seedance 2.5 Prompt Guide & Skill — Markdown snapshot](third-party/Dreamina-Seedance-2.5-Prompt-Guide-and-Skill.md)

## 版权说明

上述官方资料的版权归其各自权利人所有。中文 PDF 为学习与检索用途的归档副本，英文部分包含官方链接与 Markdown 快照；所有第三方资料均不因本仓库的 MIT License 而获得重新许可。引用、下载或再分发时请遵守对应网站的条款与版权声明。
